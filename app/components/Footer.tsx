    ...
    <footer className="py-12 border-t border-surface-border bg-surface/50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col items-center gap-8 relative z-10">
        ...
        <div className="flex gap-6 mt-0">
          ...
          <a href="https://github.com/babitaneupane" className="text-foreground/60 hover:text-accent transition-colors text-lg uppercase tracking-widest"> <FaGithub /></a>




          <a href="https://www.linkedin.com/in/babita-neupane-a0248a275/" className="text-foreground/60 hover:text-accent transition-colors text-lg uppercase tracking-widest"> <FaLinkedin /></a>
        </div>

        <div className="w-full h-[1px] bg-surface-border/50 my-4"></div>

        <p className="text-foreground/40 text-sm font-light">
          &copy; {new Date().getFullYear()} Babita Neupane.
        </p>
      </div>
    </footer>
  );
